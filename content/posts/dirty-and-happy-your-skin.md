---
introtext: Clean freak or slob? To wash or not to wash? And how often? With soap or without soap? These questions a few years ago seemed silly with obvious answers. But with the dawn of the microbiome era, everything changed. </span><span>It turns out that the microbes on our body and inside it don’t have to be killed! Moreover, if we kill them, they will kill us back not only because they are significantly more evolved than we are in evolutionary terms. But also because we cannot do without them. And here’s why.
created: '2019-04-05'
title: Dirty and Happy - Your Skin
alias: dirty-and-happy-your-skin
date: 05 April 2019
images:
- '![](../images/skin.jpg)'
---
...
Second, bacteria synthesize and secrete into the surrounding environment peptides with antimicrobial activity, which do not interfere with neighbors but “smell bad” to newcomers. They can do this themselves or push our skin cells to produce such weaponry. For example, [for instance](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC2922455/), epidermal Staphylococcus interacts with TLR2 receptors on the surface of keratinocytes, which in turn release substances that inhibit the growth of Streptococcus and Staphylococcus aureus. A somewhat different [method](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC4744460/), but just as effectively, epidermal Staphylococcus makes our cells [more resistant](https://www.researchgate.net/publication/318032776_Cutaneous_Leishmaniasis_Induces_a_Transmissible_Dysbiotic_Skin_Microbiota_that_Promotes_Skin_Inflammation) to possible infection with leishmaniasis.

In addition, as research shows, the skin microbiome not only [influences our immunity](http://jddonline.com/articles/dermatology/S1545961617P0012X/3) but actually [teaches and nurtures it]. Without microbes on our skin, certain immune system cells [cannot](https://www.sciencedirect.com/science/article/pii/S0091674916311307) mature and acquire the ability to protect us from something.

A healthy microbiota also [calms](http://jddonline.com/articles/dermatology/S1545961617P0012X/3) our immune system, giving it the command to restrain its emotions and not overdo inflammatory responses. This is precisely the case when a small pimple can be a pink dot or a red patch on half of the face.
...
- Moderation in cleansing procedures. Their frequency should be defined by your lifestyle and the intensity of skin contamination.
- For some this may sound scary, but if you do not unload coal wagons, a daily shower gel is not needed (if you did unload them, not always) — everything that can be washed off without detergents, should be washed off without detergents.
- The same goes for antiperspirants — using them with excessive sweating because “it’s a given” is not worth it. If you do not want to worsen the situation;
- When choosing hygiene products (shower gel, facial cleansers, shampoos, etc.), choose those that do not contain or contain fewer antibacterial substances. Without a doctor’s recommendation, do not use products daily that contain, at least in the first half of the ingredient list, substances with pronounced antimicrobial action. This includes, for example, ethyl and isopropyl alcohol, benzalkonium chloride, salicylic and glycolic acids, etc.
- Whenever possible, choose pump-type dispensers — where the product does not contact air and the environment, and therefore contains fewer preservatives needed to preserve the product itself;
- Instead, try to touch your face with dirty hands less — this will not only save the skin from unwanted irritation but also prevent the spread of respiratory diseases. Clean your mobile phone, which we often hold to the ear and cheek!
- Do not overdo it with products and procedures that promise “deep cleansing.” Their necessity should be determined by your dermatologist. Of course, the same goes for antibiotics. Let your skin be not perfectly clean, but perfectly healthy! :)
