---
introtext: We’ve all heard that vegetables-fruits-whole grains are “healthy, because they contain fiber,” and that it “cleans the gut.” What exactly do we need fiber for, what is it anyway, and does it really clean something somewhere—let’s figure it out now.
created: '2019-05-03'
title: Why Fiber in the Diet Is Really Important?
alias: why-fiber-in-the-diet-is-really-important
date: 03 May 2019
images:
...
After almost two thousand years, chemists took on the task and classified as fiber everything that remains from a plant matter in a test tube after the action of acids and alkalis. They also produced an elaborate classification that eyes cannot help but to adore! Those who wish to enjoy it fully — we invite you [here](https://www.sciencedirect.com/science/article/pii/S1021949816301429#bib2) or [here](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3614039/).
...
It has also been shown that [low diversity of the gut microbiota correlates with higher **body mass index** and **inflammatory processes in the gut**](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6340974/).

As we already [wrote](kyshkova-mikrobiota-retsept-metelykiv-v-zhyvoti.html) earlier, the aforementioned SCFAs are the **food for intestinal epithelial cells** and also signaling molecules for enteroepithelial cells, which synthesize for us the "**happiness hormones**." These SCFAs also affect the **T-cell arm of our immune system** and thereby exhibit a **local anti-inflammatory effect**.
...
* [Recommended](https://www.accessdata.fda.gov/scripts/InteractiveNutritionFactsLabel/factsheets/Dietary_Fiber.pdf) daily fiber intake is about 25 g per day (based on a 2000 kcal diet). For example, one apple, banana, orange, or carrot contains 2-4 g of fiber depending on size. Tables with fiber content in various products are [here](https://www.med.umich.edu/mott/pdf/mott-fiber-chart.pdf) and [here](https://ndb.nal.usda.gov/ndb/nutrients/report/nutrientsfrm?max=25&offset=0&totCount=0&nutrient1=291&nutrient2=&nutrient3=&subset=0&sort=c&measureby=m).
