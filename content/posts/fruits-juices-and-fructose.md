---
introtext: Can you really gain weight easily from fruits? How many can you eat? Are fruit juices healthy and should you be happy about fructose syrup on the label?
created: '2019-10-11'
title: Fruits, Juices, and Fructose
alias: fruits-juices-and-fructose
...
[At least](https://www.ncbi.nlm.nih.gov/pubmed/31451258), by three factors:

- Water content in fruits is about 90%, while in the vast majority of confectionery products it is up to 5%;
- Sugar content in fruits is 10-15% (in dates 65%), while sweets can sometimes exceed 90%;
- The presence in fruits of other valuable nutrients, including vitamins, minerals, antioxidants, and also fiber, whereas sweets can become an additional source of saturated and trans fats.

**Fruits vs juices**

On the one hand, fruit juices are associated with "vitamins and minerals," and on the other hand — sometimes a "spoon of tar" in the form of added sugar. But even if it is not some nectar with added sugar, juices contain significantly less fiber than fruits, so all [benefits](chomu-klitkovyna-v-ratsioni-tse-spravdi-vazhlyvo.html) related to fiber will be less pronounced. In addition, sugars from juices are thus absorbed into the blood more quickly and in greater amounts, causing that dreaded spike.

In some studies [it has been shown](https://www.ncbi.nlm.nih.gov/pubmed/23990623) that the consumption of whole fruits is associated with a reduced risk of developing type 2 diabetes, while consumption of fruit juices — conversely — with increased risks.

The National Health Service of the United Kingdom [recommends](https://www.nhs.uk/live-well/eat-well/the-eatwell-guide/) limiting the amount of fruit juices and smoothies consumed to 150 ml per day.
...
Therefore, [overall](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC5084020/) consumption of whole fruits is associated with a reduction in body weight. At the same time, consuming large amounts of fruit juices is not recommended for certain age groups, especially children.

**How much fruit to eat?**

It depends on age, sex, and level of physical activity. According to [the recommendations](https://www.choosemyplate.gov/eathealthy/fruits) from USDA, adult men, as well as women up to age 30, are advised to consume two servings of fruit per day, women over 30 — one and a half servings. Separate recommendations are provided for children and adolescents.
...
Fructose metabolism does not involve satiety hormones, so it does not give us a feeling of fullness. And excessive consumption of fructose [can lead to](https://www.ncbi.nlm.nih.gov/pubmed/28878197) fatty liver, visceral fat accumulation, and other metabolic disorders.
