---
introtext: We will not list arguments for why “we should.” We tried to talk a little about why “arguments don’t always achieve the goal.” After speaking with representatives of different viewpoints and sides, we present points that, in our humble opinion, could improve collaboration.
created: '2019-02-07'
title: 'Vaccination: A Communication Crisis'
alias: vaccination-a-communication-crisis
...
* How are these sources connected to [evidence-based medicine](dokazova-medytsyna-dlia-chainykiv-shcho-nam-z-toho.html)?
* If this is the position of some specific person who is an authority for you — does this person have to do with medicine?
* If you read or watched "something" on the internet — does it have an author (Who is this author? What does he do? Why should we trust him?)
* If you read or watched "something" on the internet — are there references (and are these *references truly to scientific publications*, and not to dubious blogs)?

Often articles or videos talk about "some studies" and refer to "experts" (sometimes fictional, sometimes far from medical professionals and scientists) - *do not hesitate to search for them*, at least on [Google S](https://scholar.google.com.ua/)[cholar](https://scholar.google.com.ua/) or [PubMed](https://www.ncbi.nlm.nih.gov/pubmed/).
