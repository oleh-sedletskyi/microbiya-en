---
introtext: We can hardly imagine modern medicine without antibiotics. But today antibiotic resistance is talked about as much as the antibiotics themselves. Not so long ago, when prescribing antibiotics, patients worried about potential harm, and now they rightfully worry whether they will work.
created: '2019-09-27'
title: 'The Magic Pill: What You Need to Know About Using Antibiotics?'
alias: the-magic-pill-what-you-need-to-know-about-using-antibiotics
...
The situation is especially acute when you need it “here and now” and there’s no time for an antibiotic susceptibility test — for such cases, sometimes a mixture of antibiotics is used right away, because the price can be paid in human lives... It happens that surgeons perform hours-long, high-precision operations, celebrate their successful completion with the family, and then encounter postoperative complications. And quite often it is some inconspicuous Staphylococcus that took the wrong path and acquired genes of multiple antibiotic resistance. And quite often this ends in patient deaths. According to the [CDC data](https://www.cdc.gov/drugresistance/index.html), in the United States every year at least 2 million people acquire antibiotic-resistant infections and at least 23 thousand of them die.
...
Bacteria evolve with [incredible speed](mikrobna-saha-sekrety-supersyly.html) — the time between generations in our species is measured in decades, while for bacteria it is tens of minutes.
...
[This should be determined only by your doctor](https://www.fda.gov/consumers/consumer-updates/combating-antibiotic-resistance). Never pressure your doctor or demand an antibiotic prescription!

- In addition to self-medication with pills, also refrain from using external products that contain antibiotics — antibacterial ointments, gels, etc.;
- However, do not refuse an antibiotic prescription if your doctor recommends it;
- Be sure to finish the entire recommended course of antibiotic therapy even if you feel better at the start of treatment. Untreated infection can be a source of recurrent antibiotic-resistant infections;
- Do not miss doses and follow the recommended dosing intervals — this also helps prevent the emergence of antibiotic-resistant mutants;
- Do not share antibiotics with other people — for each individual case, a drug that is best for each patient must be prescribed and used;
- Monitor storage conditions and expiration dates of medications.
