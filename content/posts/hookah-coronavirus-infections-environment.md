---
introtext: Hookah smoking has gained significant popularity in virtually every country around the world. Therefore, questions about their safety, impact on health, the environment, and air quality on our streets are highly relevant. Today, the international community also considers hookahs a potential infectious threat, as they are excellent reservoirs for storing and transmitting SARS-CoV-2.
created: '2020-06-04'
title: 'Hookah: Coronavirus, Infections, Environment'
alias: hookah-coronavirus-infections-environment
date: 04 June 2020
images:
...
Hookah smoking has been linked to cases of [tuberculosis](https://www.researchgate.net/publication/10569228_A_cluster_of_tuberculosis_associated_with_use_of_marijuana_water_pipe). It is also easy to contract [Helicobacter infection](https://apps.who.int/iris/handle/10665/117395?locale-attribute=ru&) through hookah.
...
The letter also [mentions](https://www.cmaj.ca/content/hookah-smoking-and-covid-19-call-action) that hookah smoke contains dangerous chemicals that damage respiratory tissues and increase susceptibility to viral infections, tuberculosis, and other infectious diseases, including coronavirus.

Regarding smoking in general, WHO also reminds that current data show a [link](https://www.who.int/news-room/commentaries/detail/smoking-and-covid-19) between smoking and an increased likelihood of disease and death among hospitalized COVID-19 patients.

Some sources [note](https://www.tribuneindia.com/news/patiala/two-booked-for-spreading-coronavirus-flouting-lockdown-norms-in-rajpura-75107) that hookah parties were associated with mass registration of active coronavirus infections.

In Germany this was carefully [tracked](https://www.dw.com/en/coronavirus-outbreak-traced-to-german-hookah-bar/a-53651444) -- **more than a few dozen people became infected in a hookah bar, and about three hundred more were placed in quarantine**.

In connection with this, experts [urge](https://untobaccocontrol.org/kh/waterpipes/covid-19/):

* Actively inform the public about the high risk of infection with the COVID-19 pathogen when smoking hookahs;
* Completely ban the use of hookahs in all public establishments such as cafes, bars, and restaurants without any exceptions, even when using individual mouthpieces and hoses;
* Reinforce the ban with appropriate penalties.
...
According to [studies](https://www.sciencedirect.com/science/article/pii/S0048969715312481?via%3Dihub), the indoor air quality index in places where hookahs are smoked is over 300 units, corresponding to the **highest degree of danger** according to air pollution level classifications.
