...
To date, [it is known](https://www.cdc.gov/coronavirus/types.html) that several coronaviruses cause respiratory diseases in humans. But because of the comparatively modest epidemiological threat, they are known mainly to virologists who study them directly.

But there are [exceptions](https://www.who.int/emergencies/mers-cov/en/). These became SARS (2002-2003, China, ~8 thousand cases, ~10% died, source — civets — animals similar to cats) and MERS (2012, mainly Saudi Arabia, ~2.5 thousand cases, ~35% died, source — camels).
...
It should be noted that among fatal cases, significantly [predominate](https://www.worldometers.info/coronavirus/coronavirus-age-sex-demographics/) older patients and those with accompanying chronic diseases — cardiovascular diseases, diabetes, and so on.

**Incubation period** , according to official data, lasts up to two weeks, on average 3-5 days. [However](https://www.worldometers.info/coronavirus/coronavirus-incubation-period/) there are isolated cases that seemingly indicate a much longer time — up to 27 days. However, there is currently no basis to claim this and to extend quarantine measures longer: specialists assume that this artifact possibly occurred due to repeated contact with a potential carrier.

**What are the symptoms?**

The main [symptoms](https://www.who.int/news-room/q-a-detail/q-a-coronaviruses) are fever, fatigue, dry cough. In some patients, you may experience sore throat, nasal congestion, or diarrhea.
...
It is now difficult to predict how the situation will develop, but there are already [several versions](https://www.businessinsider.com/wuhan-coronavirus-mild-pandemic-how-it-could-end-2020-2).
...
There is good news too — Ukrainian [researchers](https://www.ukrgentech.com) have developed test systems for detecting the coronavirus. These test systems are sets for PCR diagnostics of COVID-2019.
